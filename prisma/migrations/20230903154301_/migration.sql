/*
  ...
  - The values [CONDO] on the enum `ProperType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ProperType_new" AS ENUM ('RESIDENTAIL', 'CONDOM');
